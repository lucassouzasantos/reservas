...
// Função para obter data no formato correto (calculada uma única vez)
...
// Calcular as datas uma única vez quando o módulo é carregado
const hoy = new Date();
...
// Reservas iniciales para demostración (dados estáticos)
